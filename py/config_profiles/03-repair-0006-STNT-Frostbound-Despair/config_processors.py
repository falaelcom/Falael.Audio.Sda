CONFIG = {
    "transform_stereo_width_fullspectrum_fulltrack":
    {
        ...
        "x_1": 1.35,           # "exponential" only - "How fast does it grow?" - lower values < 1 - faster rise, higher values > 1 - stays lower for longer
        "flatness": 0.8,    # "exponential" only - "How dramatically curved is it? - lower values [0..1] - closer to a line; higher values > 1 - more curved, steeper in the end"
